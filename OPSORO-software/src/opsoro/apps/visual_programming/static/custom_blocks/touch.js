...
<<<<<<< HEAD:OPSORO-software/src/opsoro/apps/visual_programming/static/custom_blocks/touch.js
  // code += touch_var + ' = bit32.extract(' + touch_var + ', ' + dropdown_electrode + ') > 0\n';
=======
  //code += touch_var + ' = bit32.extract(' + touch_var + ', ' + dropdown_electrode + ') > 0\n';
>>>>>>> refs/remotes/origin/master:OnoSW/apps/visprog/static/custom_blocks/touch.js
