...
config = {"full_name": "Tiktak", "icon": "fa-clock-o"}
...
def setup_pages(opsoroapp):
	app_bp = Blueprint("tiktak", __name__, template_folder="templates", static_folder="static")
	...
	def index():
		...
		return opsoroapp.render_template("tiktak.html", **data)
