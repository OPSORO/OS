...
config = {"full_name": "Emodetection", "icon": "fa-eye"}
...
def setup_pages(opsoroapp):
	app_bp = Blueprint("emodetection", __name__, template_folder="templates", static_folder="static")
	...
	def index():
		...
		return opsoroapp.render_template("emodetection.html", **data)
